...
// Shaders
import containerVertexShaderSource from "~/lib/scenes/lighting-maps-diffuse/container.vert?raw";
import containerFragmentShaderSource from "~/lib/scenes/lighting-maps-diffuse/container.frag?raw";
import lightVertexShaderSource from "~/lib/scenes/lighting-maps-diffuse/light.vert?raw";
import lightFragmentShaderSource from "~/lib/scenes/lighting-maps-diffuse/light.frag?raw";
