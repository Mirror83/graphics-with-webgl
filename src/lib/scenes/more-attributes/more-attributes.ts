...
// Shaders
import vertexShaderSource from "~/lib/scenes/more-attributes/more-attributes.vert?raw";
import fragmentShaderSource from "~/lib/scenes/more-attributes/more-attributes.frag?raw";
