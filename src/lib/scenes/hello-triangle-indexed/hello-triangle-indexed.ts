...
// Shaders
import vertexShaderSource from "~/lib/scenes/hello-triangle-indexed/hello-triangle-indexed.vert?raw";
import fragmentShaderSource from "~/lib/scenes/hello-triangle-indexed/hello-triangle-indexed.frag?raw";
