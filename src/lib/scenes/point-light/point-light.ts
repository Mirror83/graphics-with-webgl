...
// Shaders
import containerVertexShaderSource from "~/lib/scenes/point-light/container.vert?raw";
import containerFragmentShaderSource from "~/lib/scenes/point-light/container.frag?raw";
import lightVertexShaderSource from "~/lib/scenes/point-light/light.vert?raw";
import lightFragmentShaderSource from "~/lib/scenes/point-light/light.frag?raw";
import { loadTexture } from "~/lib/textures";

const pointLight: RenderWrapper = (canvas) => {
