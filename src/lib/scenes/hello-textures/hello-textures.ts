...
// Shaders
import vertexShaderSource from "~/lib/scenes/hello-textures/hello-textures.vert?raw";
import fragmentShaderSource from "~/lib/scenes/hello-textures/hello-textures.frag?raw";
