...
// Shaders
import containerVertexShaderSource from "~/lib/scenes/lighting-maps-specular/container.vert?raw";
import containerFragmentShaderSource from "~/lib/scenes/lighting-maps-specular/container.frag?raw";
import lightVertexShaderSource from "~/lib/scenes/lighting-maps-specular/light.vert?raw";
import lightFragmentShaderSource from "~/lib/scenes/lighting-maps-specular/light.frag?raw";
import { loadTexture } from "~/lib/textures";

const lightingMapsSpecular: RenderWrapper = (canvas) => {
...
export default lightingMapsSpecular;
